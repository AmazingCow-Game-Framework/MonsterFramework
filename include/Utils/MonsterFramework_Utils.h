...
#ifndef __MonsterFramework_MonsterFramework_Utils_h__
#define __MonsterFramework_MonsterFramework_Utils_h__
...
NS_MF_END
#endif // defined(__MonsterFramework_MonsterFramework_Utils_h__) //
