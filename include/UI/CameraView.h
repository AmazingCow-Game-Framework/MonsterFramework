...
#ifndef __MonsterFramework_include_UI_CameraView_h__
#define __MonsterFramework_include_UI_CameraView_h__
...
NS_MF_END
#endif // defined(__MonsterFramework_include_UI_CameraView_h__) //
