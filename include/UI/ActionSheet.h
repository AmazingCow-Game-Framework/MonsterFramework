...
#ifndef __MonsterFramework_include_UI_ActionSheet_h__
#define __MonsterFramework_include_UI_ActionSheet_h__
...
public:
    ActionSheet();
    ActionSheet(const std::string &title,
...
NS_MF_END
#endif // defined(__MonsterFramework_include_UI_ActionSheet_h__) //
