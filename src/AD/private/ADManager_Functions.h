...
#ifndef __MonsterFramework_ADManager_Functions_h__
#define __MonsterFramework_ADManager_Functions_h__
...
NS_MF_END
#endif // defined(__MonsterFramework_ADManager_Functions_h__)
